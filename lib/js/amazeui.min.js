        ...
        (function(e) {
            ...
            n.flexslider = function(t, i) {
                ...
                g = {
                    ...
                    touch: function() {
                        ...
                        function n(i) {
                            ...
                            if (n) {
                                ...
                                i.detail === i.MSGESTURE_FLAG_INERTIA ? void e(function() {
                                    t._gesture.stop()
                                }) : void ((!b || Number(new Date) - v > 500) && (i.preventDefault(),
                                !f && n.transitions && (n.vars.animationLoop || (h = C / (0 === n.currentSlide && C < 0 || n.currentSlide === n.last && C > 0 ? Math.abs(C) / u + 2 : 1)),
                        ...
                        y = function(t) {
                            ...
                            !f && s.transitions && (s.vars.animationLoop || (h /= 0 === s.currentSlide && h < 0 || s.currentSlide === s.last && h > 0 ? Math.abs(h) / u + 2 : 1),
                ...
                s.flexAnimate = function(t, e, i, o, a) {
                    ...
                    v && 1 === s.pagingCount && (s.direction = s.currentItem < t ? "next" : "prev"),
        ...
        n.prototype = {
            ...
            _transitionTime: function(t) {
                if (this.options.useTransition) {
                    ...
                    if (e && (this.scrollerStyle[e] = t + "ms",
                    !t && a.isBadAndroid)) {
        ...
        function n() {
            s('[data-am-widget="header"]').each(function() {
                if (s(this).hasClass("am-header-fixed"))
                    return s("body").addClass("am-with-fixed-header"),
                    !1
            })
        }
        var s = i(1)
